...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('个人记录_-_游客.html');
...
gv_vAlignTable['u55'] = 'center';gv_vAlignTable['u21'] = 'center';document.getElementById('u24_img').tabIndex = 0;
...
gv_vAlignTable['u39'] = 'center';gv_vAlignTable['u1'] = 'center';gv_vAlignTable['u2'] = 'top';gv_vAlignTable['u3'] = 'top';gv_vAlignTable['u4'] = 'top';gv_vAlignTable['u5'] = 'top';gv_vAlignTable['u7'] = 'center';gv_vAlignTable['u9'] = 'center';document.getElementById('u42_img').tabIndex = 0;
...
gv_vAlignTable['u41'] = 'center';document.getElementById('u48_img').tabIndex = 0;
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('首页_-_附近导游.html');

}
});
gv_vAlignTable['u49'] = 'center';document.getElementById('u44_img').tabIndex = 0;
...
gv_vAlignTable['u45'] = 'center';gv_vAlignTable['u43'] = 'center';gv_vAlignTable['u47'] = 'center';document.getElementById('u46_img').tabIndex = 0;
...
gv_vAlignTable['u11'] = 'center';gv_vAlignTable['u13'] = 'center';gv_vAlignTable['u15'] = 'center';gv_vAlignTable['u17'] = 'center';document.getElementById('u18_img').tabIndex = 0;
