...
public class BroadcastActivity extends BaseActivity implements OnClickListener {
	...
	private void sendBroadcast() {
		...
		TipsDialog.getInstance().show(this, R.drawable.tips_loading,
				R.string.sending_broadcast, true, false);
		mInviteHelper.inviteAll(destination.trim(), mStartTimeStamp,
				mEndTimeStamp, AppRuntime.gLocation, gender);
	}
			...
			mHandler.post(new Runnable() {
				...
				public void run() {
					...
					if (result == InviteHelper.SUCCESS) {
						...
						TipsDialog.getInstance().show(BroadcastActivity.this,
	...
	private void broadcastSuccess() {
		TipsDialog.getInstance().show(BroadcastActivity.this,
				R.drawable.tips_saved, R.string.broadcast_success, true);
