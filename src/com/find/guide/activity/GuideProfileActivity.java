...
import com.find.guide.user.UserHelper.OnGetUserInfoFinishListener;
...
public class GuideProfileActivity extends BaseActivity implements OnClickListener {
    ...
    private TextView mBeGuideYearTv;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null && getIntent() != null) {
            ...
            mGuideId = getIntent().getIntExtra(INTENT_EXTRA_GUIDE_ID, 0);
            if (mTourGuide != null) {
                mGuideId = mTourGuide.getUserId();
            }
        }
        ...
        if (mTourGuide != null) {
            ...
            mDesinatinoView.setVisibility(View.GONE);
            ...
            mHandler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    TipsDialog.getInstance().show(GuideProfileActivity.this, R.drawable.tips_loading, "", true, false);
                    mUserHelper.getUserInfo(mGuideId, mOnGetUserInfoFinishListener);
                }
            }, 300);
        }
    ...
    private void initUI() {
        ...
        mBeGuideYearTv = (TextView) findViewById(R.id.be_guide_year_tv);
        ...
        mTravelAgencyTv = (TextView) findViewById(R.id.travel_agency_tv);

        mDesinatinoView = findViewById(R.id.destination_layout);
    ...
    private void setGuideInfo() {
        ...
        int star = 0;
        if (mTourGuide.getEvaluateCount() > 0) {
            star = Math.round(mTourGuide.getEvaluateScore() * 1.0f / mTourGuide.getEvaluateCount());
        }
        setStar(star);
        ...
        mBeGuideYearTv.setText("" + mTourGuide.getBeGuideYear());
    }
    ...
    private void initBooking() {
        mDesinatinoView.setVisibility(View.VISIBLE);
        mStartTimeView.setVisibility(View.VISIBLE);
        mEndTimeView.setVisibility(View.VISIBLE);
        mBookingBtn.setVisibility(View.VISIBLE);
    ...
    private OnGetUserInfoFinishListener mOnGetUserInfoFinishListener = new OnGetUserInfoFinishListener() {

        @Override
        public void onGetUserInfo(final int result, final Tourist tourist) {
            mHandler.post(new Runnable() {
                @Override
                public void run() {
                    TipsDialog.getInstance().dismiss();
                    if (result == UserHelper.SUCCESS) {
                        if (tourist != null && tourist instanceof TourGuide)
                            mTourGuide = (TourGuide) tourist;
                        setGuideInfo();
                    } else if (result == UserHelper.FAILED) {
                        TipsDialog.getInstance()
                                .show(GuideProfileActivity.this, R.drawable.tips_fail, "加载导游信息失败", true);
                    }
                }
            });
        }
            ...
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    if (result == InviteHelper.SUCCESS) {
                        TipsDialog.getInstance().show(GuideProfileActivity.this, R.drawable.tips_saved,
                        ...
                        TipsDialog.getInstance().show(GuideProfileActivity.this, R.drawable.tips_fail,
        ...
        mAlertDialog = new AlertDialog.Builder(this).setMessage(R.string.login_dialog_message)
                .setPositiveButton(R.string.login_dialog_positive, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(GuideProfileActivity.this, LoginActivity.class);
                        startActivity(intent);
                    }
        ...
        mDateTimePickerDialog = new DateTimePickerDialog(this, new ICustomDateTimeListener() {
            ...
            public void onSet(Calendar calendarSelected, Date dateSelected, int year, String monthFullName,
                ...
                if (isDateTimeValid(dateSelected.getTime())) {
                    ...
                    TipsDialog.getInstance().show(GuideProfileActivity.this, R.drawable.tips_fail, "不能输入过去的时间", true);
                }
